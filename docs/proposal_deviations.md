...
| Use 100 calibration cases and 200 human labeled held out cases for grounding. | Keep a 40 case annotation pilot. Of its 35 eligible cases, use 20 for calibration and 15 for held out evaluation, then lock grounding prompt version 3. | No per triple human accuracy estimate is claimed. The grounding assessor is a fixed automated instrument, not human ground truth. Its mismatches and baseline noise remain visible. |
